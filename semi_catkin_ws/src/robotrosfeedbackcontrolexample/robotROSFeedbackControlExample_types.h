...
typedef struct P_robotROSFeedbackControlExam_T_ P_robotROSFeedbackControlExam_T;

// Forward declaration for rtModel
typedef struct tag_RTM_robotROSFeedbackContr_T RT_MODEL_robotROSFeedbackCont_T;
